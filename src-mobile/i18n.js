...
const D = {
  ...
  '已登录 · {s}': 'Signed in · {s}', 'Apple 账号': 'Apple ID', 'Google 账号': 'Google account', '上次同步 {s}': 'Last synced {s}', '还没同步过': 'Not synced yet',
  '立即同步': 'Sync now', '同步中…': 'Syncing…', '退出登录': 'Sign out', '删除账号': 'Delete account', '再点一次确认删除': 'Tap again to confirm',
  '删除中…': 'Deleting…', '账号已删除，本机记录还在': 'Account deleted; records on this device are kept', '没删成，稍后再试': 'Could not delete, try later',
  '删的是账号和云端数据；这台设备上的记录不动': 'Deletes the account and cloud data; records on this device stay',
