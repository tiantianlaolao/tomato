...
const P = {
  board:  { x:0.100, y:0.350, x2:0.410, y2:0.505 },   // 木牌牌面（数字槽，裁切安全区内）
  lampBox:{ x:0.700, y:0.335, x2:0.930, y2:0.585 },   // 石灯笼（设置入口）
  stone:  { x:0.500, y:0.495, x2:0.680, y2:0.555 },   // 灯笼左侧石头（记录入口）
};
...
window.SCENES.onsen = {
  ...
  // 数字：刻在木牌上的深棕字 + 浅色凹凸边
  time: { ...P.board, ink:'#f7d3a4', paper:'#4a2b16' },
  entries: { start:P.board, settings:P.lampBox, stats:P.stone },
